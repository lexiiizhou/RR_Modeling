...
# Recoveralphas = np.arange(0.01, 1.01, 0.1)
...
print('best gamma for model 2 is {0}'.format(bestparameters2[2]))
...
for sa in range(nsamples):
    ...
    beta = np.aranage(0.01, 1.01, 0.1)
    delta = np.arange(0.01, 1.01, 0.1)
    gamma = np.arange(-0.5, 0.5, 0.1)
...
simulated_028 = pd.DataFrame(simulated_028, columns=['session_day', 'trial', 'restaurant', 'tone_prob',
                                                  'accept', 'U', 'choice_p'])

plot_prob(simulated_028, 'RRM028 Simulated', R_028, fig_save=fig_save)
plot_pellets(simulated_028, 'RRM028 Simulated', fig_save=fig_save)
...
simulated_029 = pd.DataFrame(simulated_029, columns=['session_day', 'trial', 'restaurant', 'tone_prob',
                                                    'accept', 'U', 'choice_p'])

plot_prob(simulated_029, 'RRM029 Simulated', R_029, fig_save=fig_save)
plot_pellets(simulated_029, 'RRM029 Simulated', fig_save=fig_save)
